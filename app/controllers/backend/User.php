...
class User extends  MY_Controller {
	...
	function add() {
		...
		require_once "app/views/backend/user/add.php";
	...
	function show() {
		...
		$row = $this->model_user->conver_data($user);
		$this->model_user->where('id',1);
		$this->model_user->update('banner', "hi");
		$this->model_user->last_query();
		require_once "app/views/backend/layout/header.php";
		require_once "app/views/backend/user/show.php";
		require_once "app/views/backend/layout/footer.php";
	...
	function edit() {
		...
		require_once "app/views/backend/layout/header.php";
		require_once "app/views/backend/user/edit.php";
		require_once "app/views/backend/layout/footer.php";
	}
}